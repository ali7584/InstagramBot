...
browser = webdriver.Chrome(executable_path= r'D:\Programing\Project\Git-Personal\Python\driver_selenium\chromedriver.exe')  # <----- ENTER PATH HERE 
...
def likeAndComm(): # Likes and Comments the first 9 posts
	...
	for y in range (1,4):
		for x in range(1,4):
			...
			comment = browser.find_element_by_xpath('/html/body/div[4]/div[2]/div/article/div[3]/section[3]/div/form').click() 
			print("click2")
			comment = browser.find_element_by_xpath('/html/body/div[4]/div[2]/div/article/div[3]/section[3]/div/form/textarea').send_keys(random.choice(comments)).send_keys(Keys.ENTER)
			print("send1")
			sleep(3)
			print("click3")
			sleep(4)
...
def start():
	...
	username.send_keys('Hosein_2021_90') # <- INSERT YOUR INSTAGRAM USERNAME HERE -------------------------------------------------------------------------------------------------------------------------
	password = browser.find_element_by_name('password')
	password.send_keys('ali@@2015ali@@2015') # <- INSERT YOUR INSTAGRAM PASSWORD HERE -----------------------------------------------------------------------------------------------------------------------
